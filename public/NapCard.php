                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Nạp thẻ cào</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <a href="/pay/bank/" class="btn btn-outline-primary btn-block"><img src="https://subgiare.vn/assets/images/icon/online-payment.svg" alt="" width="25" height="25"> Chuyển khoản
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="#" class="btn btn-primary btn-block" style="background-color:#8f93f6"><img src="https://subgiare.vn/assets/images/icon/credit-card.svg" alt="" width="25" height="25"> Thẻ cào
                        </a>
                    </div>
                </div>
            </div>
                ...
                <center><button style="border-radius: 100px; " type="button" class="btn btn-success" data-dismiss="modal">OK</button></center>
                    ...
                    <div class="col-md-12">
                        <div class="alert text-white bg-secondary" role="alert">
                                 - Tổng Nạp 500k giảm 5%, 1Tr giảm 10%, 3Tr giảm 15%, 5Tr giảm 20% giá trị đơn hàng
                            <br> - Bạn vui lòng chuyển khoản chính xác nội dung để được cộng tiền nhanh nhất.
