                ...
                <form role="form" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="pin">
                            ...
                            <option value="mailclone">mailclone</option>
                            <option value="mailvia">mailvia</option>
                            <option value="mail0bb">mail0bb</option>
                            <option value="mailnull">mailnull</option>
                            <option value="mailviafl">mailviafl</option>
