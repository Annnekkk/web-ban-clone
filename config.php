...
define("DATABASE", "tmailscantpcom_tuanori");
define("USERNAME", "tmailscantpcom_tuanori");
define("PASSWORD", "tmailscantpcom_tuanori");
...
function sendCSM($mail_nhan,$ten_nhan,$chu_de,$noi_dung,$bcc){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'spzangyt@gmail.com'; //GMAIL BOT
        $mail->Password = 'csnlmjwhgwynqzmh'; // PASS GMAIL BOT
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        $mail->setFrom('spzangyt@gmail.com', $bcc); //GMAIL BOT
        $mail->addAddress($mail_nhan, $ten_nhan);
        $mail->addReplyTo('spzangyt@gmail.com', $bcc); //GMAIL BOT
        $mail->isHTML(true);
        $mail->Subject = $chu_de;
        $mail->Body    = $noi_dung;
        $mail->CharSet = 'UTF-8';
